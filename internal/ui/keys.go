...
var allBindings = []BindingGroup{
	{"General", []Binding{
		...
		{Key: "o", Desc: "Toggle overlap collapse (Branch mode)", GitOnly: true},
	...
	{"Diff View", []Binding{
		...
		{Key: "+/-", Desc: "More/fewer context lines (by 3)", GitOnly: true},
		{Key: "0", Desc: "Reset context to default", GitOnly: true},
